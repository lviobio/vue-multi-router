...
import { NLayoutHeader, NMenu, type MenuProps } from 'naive-ui'
import { h } from 'vue'
...
// Keys match the route names, so NMenu highlights the current section
const subMenuOptions: NonNullable<MenuProps['options']> = [
  {
